...
| :---------------------- | :---------------------- | :---------------------- |:---------------------- |
| [Проект для АНО "Рак победим"](7.Senior_project) |  Анализ данных о подопечных и донорах фонда, построение дашборда для формирования фондом отчетности за 2023 год.| *Pandas, Matplotlib, Seaborn, Re, FuzzyWuzzy* |Завершен |
